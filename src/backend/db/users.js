...
export const users = [
  ...
  },
  {
    ...
    header: "https://res.cloudinary.com/ddqytua2y/image/upload/v1689196479/Social-media-app-assets/onqxal5bbxhe6g2vnmes.jpg",
    // followers: [],
    // following: [],
    bookmarks: [],
    bio: "Web Developer | 🧑‍💻 | 🏏 ",
  ...
  },
  {
    ...
    header: "https://res.cloudinary.com/ddqytua2y/image/upload/v1689194941/Social-media-app-assets/wrziltwvtluz3xwqcr7f.jpg",
    // followers: [],
    // following: [],
    bookmarks: [],
    bio: "Co-Founder, Zerodha | True Beacon | Gruhas",
    website: "https://www.forbes.com/profile/nikhil-kamath/?sh=cfb184428314",
    location: "Bengaluru, India",
    createdAt: formatDate(),
    updatedAt: formatDate(),
  },
 
  {
    ...
    header: "https://res.cloudinary.com/ddqytua2y/image/upload/v1689195376/Social-media-app-assets/e6dshxhjcbgulhlfjmge.jpg",
    // followers: [],
    // following: [],
    bookmarks: [],
    bio: "Wanderlust.",
    website: "https://en.wikipedia.org/wiki/Kendall_Jenner",
  ...
  },
  {
    ...
    header: "https://res.cloudinary.com/ddqytua2y/image/upload/v1689195860/Social-media-app-assets/ns4sxushldxzi1jt3c3k.jpg",
    // followers: [],
    // following: [],
    bookmarks: [],
    bio: "Professional Crickter | NZ",
    website: "https://www.cricbuzz.com/profiles/6326/kane-williamson",
  ...
  },
  {
    ...
    header: "https://res.cloudinary.com/ddqytua2y/image/upload/v1689196144/Social-media-app-assets/ofqjfucaljuodtbtayfx.jpg",
    // followers: [],
    // following: [],
    bookmarks: [],
    bio: "It won't always be easy, but always try to do what's right.",
    website: "https://en.wikipedia.org/wiki/Dakota_Johnson",
